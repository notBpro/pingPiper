...
class LeaguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create league" do
    assert_difference("League.count") do
      post leagues_url, params: { league: { code: @league.code, description: @league.description, name: @league.name } }
    end
  ...
  test "should update league" do
    patch league_url(@league), params: { league: { code: @league.code, description: @league.description, name: @league.name } }
